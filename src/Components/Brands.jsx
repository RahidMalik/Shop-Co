                ...
                <div className='grid  grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 p-4 sm:p-6 lg:p-8'>
                    ...
                    <div className='w-full'>
                        <div className='aspect-[4/5] cursor-pointer w-full overflow-hidden rounded-xl'>
                            ...
                            className='w-full h-full object-cover' src={img2} alt="T-Shirt With Tape Details" />
                        </div>
                        <h1 className='mt-3 sm:mt-4 text-sm sm:text-base lg:text-lg font-bold leading-tight'>Skinny Fit Jeans</h1>
                        <div className='flex items-center space-x-1 sm:space-x-2 mt-2'>
                            <div className='flex space-x-1'>
                                <ion-icon className="text-yellow-500 text-sm sm:text-base" name="star-sharp"></ion-icon>
                                <ion-icon className="text-yellow-500 text-sm sm:text-base" name="star-sharp"></ion-icon>
                    ...
                    <div className='w-full'>
                        <div className='aspect-[4/5] cursor-pointer w-full overflow-hidden rounded-xl'>
                            <img onClick={() => navigate("/product/:id")} 
                             className='w-full h-full object-cover' src={img3} alt="T-Shirt With Tape Details" />
                        </div>
                        <h1 className='mt-3 sm:mt-4 text-sm sm:text-base lg:text-lg font-bold leading-tight'>Checkered Shirt</h1>
                        <div className='flex items-center space-x-1 sm:space-x-2 mt-2'>
                            <div className='flex space-x-1'>
                                <ion-icon className="text-yellow-500 text-sm sm:text-base" name="star-sharp"></ion-icon>
                                <ion-icon className="text-yellow-500 text-sm sm:text-base" name="star-sharp"></ion-icon>
                    ...
                    <div className='w-full'>
                        <div className='aspect-[4/5] cursor-pointer w-full overflow-hidden rounded-xl'>
                            <img onClick={() => navigate("/product/:id")} 
                            className='w-full h-full object-cover' src={img4} alt="T-Shirt With Tape Details" />
                        </div>
                        <h1 className='mt-3 sm:mt-4 text-sm sm:text-base lg:text-lg font-bold leading-tight'>Sleeve Striped T-Shirt</h1>
                        <div className='flex items-center space-x-1 sm:space-x-2 mt-2'>
                            <div className='flex space-x-1'>
                                <ion-icon className="text-yellow-500 text-sm sm:text-base" name="star-sharp"></ion-icon>
                                <ion-icon className="text-yellow-500 text-sm sm:text-base" name="star-sharp"></ion-icon>
